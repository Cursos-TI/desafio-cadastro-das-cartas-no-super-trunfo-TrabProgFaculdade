...
int main() {
    ...
    unsigned long int populacao1 = 12325000, populacao2 = 6748000; //declara a variável 'população 1 e 2' como número inteiro, fixando os números.//
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
    char carta1 [30] = "Carta 1"; //declara a variável 'carta1' como char.// 
    char carta2 [30] = "Carta 2"; //declara a variável 'carta2' como char.//

    float supertrunfo1 = (populacao1 + area1 + pib1 + pontos1 + ppc1) - dpp1; //declara a variável 'supertrunfo1' atribuindo o valor pelo somatório das variáveis.// 
    float supertrunfo2 = (populacao2 + area2 + pib2 + pontos2 + ppc2) - dpp2; //declara a variável 'supertrunfo2' atribuindo o valor pelo somatório das variáveis.//
    ...
    int resultadoppc; 
    int resultadodpp; 
    int resultadosupertrunfo; 
    resultadopopulacao = populacao1 > populacao2; //atribui o resultado da comparação entre os valores das populações utilizando o operador relacional.// 
    resultadoarea = area1 > area2; //atribui o resultado da comparação entre os valores das areas utilizando o operador relacional.//
    resultadopib = pib1 > pib2; //atribui o resultado da comparação entre os valores dos PIBs utilizando o operador relacional.//
    resultadopontos = pontos1 > pontos2; //atribui o resultado da comparação entre os valores dos pontos utilizando o operador relacional.//
    resultadoppc = ppc1 > ppc2; //atribui o resultado da comparação entre os valores dos PIBs per capita utilizando o operador relacional.//
    resultadodpp = dpp1 < dpp2; //atribui o resultado da comparação entre os valores das densidades populacionais utilizando o operador relacional.//
    resultadosupertrunfo = supertrunfo1 > supertrunfo2; //atribui o resultado da comparação entre os valores dos surpertrunfos utilizando o operador relacional.//

    printf("Comparacao das cartas: \n"); 
    printf("Populacao: %s venceu %d \n", carta1, resultadopopulacao); //informa na tela o resultado da comparação.//
    printf("Area: %s venceu %d \n", carta1, resultadoarea); //informa na tela o resultado da comparação.//
    printf("PIB: %s venceu %d \n", carta1, resultadopib); //informa na tela o resultado da comparação.//
    printf("Pontos Turisticos: %s venceu %d \n", carta1, resultadopontos); //informa na tela o resultado da comparação.//
    printf("Densidade populacional: %s venceu %d \n", carta2, resultadodpp); //informa na tela o resultado da comparação.//
    printf("PIB per Capita: %s venceu %d \n", carta1, resultadoppc); //informa na tela o resultado da comparação.//
    printf("Super Trunfo: %s venceu %d \n", carta1, resultadosupertrunfo); //informa na tela o resultado da comparação.//
